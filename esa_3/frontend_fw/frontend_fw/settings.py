...
ADMINS = (
    ('Jana Deutschlaender', 'deutschlaender@cosmocode.de'),
)
...
LESS_EXEC = 'lessc'
LESS_FOLDER = os.path.join(APP_DIR, 'static', 'less')
LESS_MAPPING = (
    (os.path.join(APP_DIR, 'static', 'less', 'style.less'), 'style.css'),
)

TEST_RUNNER = 'core.testing.DbLessTestRunner'


# Make this unique, and don't share it with anybody.
SECRET_KEY = 'qb%*58&pxn_8w%!*jl*9i)u)y@%echt$1q1zrldi*&h_x(y&e$'
...
ROOT_URLCONF = 'frontend_fw.urls'
#ROOT_URLCONF = 'core.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'frontend_fw.wsgi.application'
